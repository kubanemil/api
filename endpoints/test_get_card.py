...
def test_get_card_success():
    response = get_card.lambda_handler(event, None)
...
def test_get_card_not_found():
    event["queryStringParameters"] = {"card_id": "666"}
...
def test_get_card_internal_error():
    del event["queryStringParameters"]["card_id"]
